                ...
                <div class="row">
                    ...
                    <div class="col-md-4 text-right">
                        <div class="btn-group" role="group" aria-label="...">
                            ...
                            <button type="button" class="btn btn-default btn-filter" data-column="status" data-value="T"><?php echo $filter['active']; ?></button>
                            <button type="button" class="btn btn-default btn-filter" data-column="status" data-value="F"><?php echo $filter['inactive']; ?></button>
                        </div>
                    </div><!-- /.col-lg-6 -->
                </div><!-- /.row -->
...
var myLabel = myLabel || {};
myLabel.category_name = <?php __encode('lblCategoryName'); ?>;
myLabel.products = <?php __encode('lblProducts'); ?>;
myLabel.order = <?php __encode('lblOrder'); ?>;
myLabel.status = <?php __encode('lblStatus'); ?>;
myLabel.active = <?php __encode('filter_ARRAY_active'); ?>;
myLabel.inactive = <?php __encode('filter_ARRAY_inactive'); ?>;
