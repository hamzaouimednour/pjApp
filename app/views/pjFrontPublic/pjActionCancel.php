<div style="margin: 0 auto; width: 1024px">
	...
	if (isset($tpl['status']))
	{
		...
		if (isset($tpl['arr']))
		{
			...
			$datetime = date($tpl['option_arr']['o_date_format'] . ', ' . $tpl['option_arr']['o_time_format'], strtotime($tpl['arr']['type'] == 'pickup' ? $tpl['arr']['p_dt'] : $tpl['arr']['d_dt']));
			...
			<table cellspacing="2" cellpadding="5" style="width: 100%">
				...
				<tbody>	
					...
					<tr>
						...
						<td><?php $payment_methods = $tpl['payment_titles']; echo $payment_methods[$tpl['arr']['payment_method']]; ?></td>
					</tr>
					<tr>
						<td><?php __('front_price'); ?></td>
						<td><?php echo pjCurrency::formatPrice($tpl['arr']['price']); ?></td>
					</tr>
					<?php
					...
					{ 
						...
						<tr>
							...
							<td><?php echo pjCurrency::formatPrice($tpl['arr']['price_delivery']); ?></td>
						</tr>
						<?php
					} 
					?>
					<tr>
						...
						<td><?php echo pjCurrency::formatPrice($tpl['arr']['subtotal']); ?></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><?php echo pjSanitize::clean($tpl['arr']['c_name']); ?></td>
					</tr>
					<tr>
						<td><?php __('front_phone'); ?></td>
						<td><?php echo pjSanitize::clean($tpl['arr']['c_phone']); ?></td>
					</tr>
					<tr>
					...
					<tr>
						<td><?php __('front_address_line_1'); ?></td>
						<td><?php echo pjSanitize::clean($tpl['arr']['c_address_1']); ?></td>
					</tr>
					<tr>
						<td><?php __('front_address_line_2'); ?></td>
						<td><?php echo pjSanitize::clean($tpl['arr']['c_address_2']); ?></td>
					</tr>
					<tr>
						<td><?php __('front_city'); ?></td>
					...
					<tr>
						<td><?php __('front_country'); ?></td>
						<td><?php echo pjSanitize::clean($tpl['arr']['c_country']); ?></td>
					</tr>
				</tbody>
				<tfoot>
					<tr>
