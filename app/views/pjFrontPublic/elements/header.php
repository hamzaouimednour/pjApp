			...
			{ 
				...
				<div class="btn-group pull-right pjFdLanguage" role="group" aria-label="">
					...
					<ul class="dropdown-menu text-capitalize" role="menu">
						...
						foreach ($tpl['locale_arr'] as $locale)
						{
							?><li><a href="#" class="fdSelectorLocale<?php echo $locale_id == $locale['id'] ? ' pjFdBtnActive' : NULL; ?>" data-id="<?php echo $locale['id']; ?>" title="<?php echo pjSanitize::html($locale['title']); ?>"><?php echo pjSanitize::html($locale['title']); ?></a></li><?php
						} 
						?>
					</ul>
				</div>
