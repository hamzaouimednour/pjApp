                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="c_name" name="c_name" class="form-control required" data-msg-required="<?php __('fd_field_required', false, true);?>">
                            </div>
                        </div><!-- /.col-md-3 -->
                    </div><!-- /.row -->
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="c_email" id="email" class="form-control email required" placeholder="info@domain.com" data-msg-required="<?php __('fd_field_required', false, true);?>"/>
                            </div>
                        </div><!-- /.col-md-3 -->
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="c_password" id="c_password" class="form-control required" data-msg-required="<?php __('fd_field_required', false, true);?>"/>
                            </div>
                        </div><!-- /.col-md-3 -->
