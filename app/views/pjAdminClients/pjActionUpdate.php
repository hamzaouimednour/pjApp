					...
					<div class="row">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="c_name" name="c_name" value="<?php echo htmlspecialchars(stripslashes($tpl['arr']['c_name'])); ?>" class="form-control required" data-msg-required="<?php __('fd_field_required', false, true);?>">
                            </div>
                        </div><!-- /.col-md-3 -->
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="c_email" id="email" value="<?php echo htmlspecialchars(stripslashes($tpl['arr']['c_email'])); ?>" class="form-control email required" placeholder="info@domain.com" data-msg-required="<?php __('fd_field_required', false, true);?>"/>
                            </div>
                        </div><!-- /.col-md-3 -->
						<div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="password" name="c_password" id="c_password" value="<?php echo pjSanitize::html($tpl['arr']['c_password']); ?>" class="form-control required" data-msg-required="<?php __('fd_field_required', false, true);?>"/>
                            </div>
                        </div><!-- /.col-md-3 -->
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="c_address_1" id="c_address_1" value="<?php echo htmlspecialchars(stripslashes($tpl['arr']['c_address_1'])); ?>" class="form-control">
                            </div>
                        </div><!-- /.col-md-3 -->
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="c_address_2" id="c_address_2" value="<?php echo htmlspecialchars(stripslashes($tpl['arr']['c_address_2'])); ?>" class="form-control">
                            </div>
                        </div><!-- /.col-md-3 -->
...
var myLabel = myLabel || {};
myLabel.email_exists = <?php __encode('email_taken'); ?>;
</script>