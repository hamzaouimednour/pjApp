...
myLabel.email = <?php __encode('email'); ?>;
myLabel.orders = <?php __encode('lblOrders'); ?>;
myLabel.revert_status = <?php __encode('revert_status'); ?>;
myLabel.exported = <?php __encode('lblExport'); ?>;
myLabel.active = <?php __encode('u_statarr_ARRAY_T'); ?>;
myLabel.inactive = <?php __encode('u_statarr_ARRAY_F'); ?>;
