	...
	<div class="modal-body">
		...
		if(!in_array($payment_method, array('bank', 'cash')))
		{
			...
			if($payment_method == 'cash')
			{
					...
					<div class="col-lg-8">
						<div class="switch m-t-xs">
							<div class="onoffswitch onoffswitch-yn">
								<input id="payment_is_active" name="o_allow_cash" value="<?php echo @$tpl['option_arr']['o_allow_cash'] == 'Yes' ? '1' : '0';?>"  type="hidden" />
								<input class="onoffswitch-checkbox" id="enablePayment" name="enablePayment" type="checkbox"<?php echo @$tpl['option_arr']['o_allow_cash'] == 'Yes' ? ' checked="checked"' : NULL; ?>>
				...
				<div class="hidden-area" style="display: <?php echo $tpl['option_arr']['o_allow_cash'] == 'Yes' ? 'block' : 'none'; ?>">
					<?php
			...
			if($payment_method == 'bank')
			{
				...
				<div class="form-group">
					...
					<div class="col-lg-8">
						<div class="switch m-t-xs">
							<div class="onoffswitch onoffswitch-yn">
								<input id="payment_is_active" name="o_allow_bank" value="<?php echo @$tpl['option_arr']['o_allow_bank'] == 'Yes' ? '1' : '0';?>"  type="hidden" />
								<input class="onoffswitch-checkbox" id="enablePayment" name="enablePayment" type="checkbox"<?php echo @$tpl['option_arr']['o_allow_bank'] == 'Yes' ? ' checked="checked"' : NULL; ?>>
								<label class="onoffswitch-label" for="enablePayment">
									<span class="onoffswitch-inner"></span>
									<span class="onoffswitch-switch"></span>
								</label>
				...
				<div class="hidden-area" style="display: <?php echo $tpl['option_arr']['o_allow_bank'] == 'Yes' ? 'block' : 'none'; ?>">
					<?php
					foreach ($tpl['lp_arr'] as $v)
					{
						?>
