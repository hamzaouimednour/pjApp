            ...
            <div class="ibox-content">
                <form action="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminProducts&amp;action=pjActionUpdate" method="post" id="frmUpdateProduct" autocomplete="off" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-4 col-xs-6">
                            <div class="form-group">
                                ...
                                <div class="switch">
                                    <div class="onoffswitch onoffswitch-yn onoffswitch-size">
                    ...
                    <div class="clearfix">
                        ...
                        <button type="button" class="btn btn-white btn-lg pull-right" onclick="window.location.href='<?php echo PJ_INSTALL_URL; ?>index.php?controller=pjAdminProducts&action=pjActionIndex';"><?php __('btnCancel'); ?></button>
                    </div><!-- /.clearfix -->
                </form>
            </div>
        </div>
...
<script type="text/javascript">
var myLabel = myLabel || {};
myLabel.size = <?php __encode('lblSize'); ?>;
myLabel.alert_title = <?php __encode('lblDeleteImage'); ?>;
myLabel.alert_text = <?php __encode('lblDeleteImageConfirm'); ?>;
myLabel.btn_delete = <?php __encode('btnDelete'); ?>;
myLabel.btn_cancel = <?php __encode('btnCancel'); ?>;
