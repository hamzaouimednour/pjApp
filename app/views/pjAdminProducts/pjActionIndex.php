...
?>
var myLabel = myLabel || {};
myLabel.image = <?php __encode('lblImage'); ?>;
myLabel.name = <?php __encode('lblName'); ?>;
myLabel.price = <?php __encode('lblPrice'); ?>;
myLabel.is_featured = <?php __encode('lblFeaturedProduct'); ?>;
myLabel.yes = <?php __encode('_yesno_ARRAY_T'); ?>;
myLabel.no = <?php __encode('_yesno_ARRAY_F'); ?>;
