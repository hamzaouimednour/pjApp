...
var myLabel = myLabel || {};
myLabel.location_name = <?php __encode('lblLocationName'); ?>;
myLabel.address = <?php __encode('lblAddress'); ?>;
myLabel.working_time = <?php __encode('menuWorkingTime'); ?>;
myLabel.delivery_fees = <?php __encode('menuDeliveryPrices'); ?>;
