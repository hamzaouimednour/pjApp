       ...
       <div class="tab-content">
            ...
            <div role="tabpanel" id="custom" class="tab-pane<?php echo $tab=='custom' ? ' active' : NULL;?>">
                <div class="panel-body">
                    ...
                    <div class="row">
                		<div class="col-lg-7 ibox-content">
                			<div id="grid"></div>
                		</div><!-- /.col-lg-7 -->
                		<div class="col-lg-5 panel no-borders">
...
myLabel.date = <?php __encode('lblDate'); ?>;
myLabel.type = <?php __encode('lblType'); ?>;
myLabel.validate_time = <?php __encode('lblValidateTime'); ?>;
myLabel.start_time = <?php __encode('lblStartTime'); ?>;
myLabel.end_time = <?php __encode('lblEndTime'); ?>;
myLabel.is_day_off = <?php __encode('lblIsDayOff'); ?>;
myLabel.delete_selected = <?php __encode('delete_selected'); ?>;
myLabel.delete_confirmation = <?php __encode('delete_confirmation'); ?>;
myLabel.alert_title = <?php __encode('lblWarning'); ?>;
myLabel.alert_text = <?php __encode('lblWTimeError'); ?>;
myLabel.btn_ok = <?php __encode('btnOK'); ?>;
</script>