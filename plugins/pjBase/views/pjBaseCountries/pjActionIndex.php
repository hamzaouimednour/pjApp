...
var myLabel = myLabel || {};
myLabel.country_name = <?php __encode('plugin_base_country_name'); ?>;
myLabel.alpha_2 = <?php __encode('plugin_base_alpha_2'); ?>;
myLabel.alpha_3 = <?php __encode('plugin_base_alpha_3'); ?>;
