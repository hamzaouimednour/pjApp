...
var myLabel = myLabel || {};
myLabel.reset_permission_title = <?php __encode('plugin_base_reset_user_permissions_title'); ?>;
myLabel.reset_permission_text = <?php __encode('plugin_base_reset_user_permissions_text'); ?>;
myLabel.btn_reset = <?php __encode('plugin_base_btn_reset'); ?>;
