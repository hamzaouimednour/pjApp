...
var myLabel = myLabel || {};
myLabel.name = <?php __encode('plugin_base_name'); ?>;
myLabel.email = <?php __encode('plugin_base_email'); ?>;
myLabel.last_login = <?php __encode('plugin_base_last_login'); ?>;
myLabel.role = <?php __encode('plugin_base_role'); ?>;
myLabel.status = <?php __encode('plugin_base_status'); ?>;
myLabel.account_locked = <?php __encode('plugin_base_account_locked'); ?>;
myLabel.yesno = <?php __encode('plugin_base_yesno'); ?>;
myLabel.set_permissions = <?php __encode('plugin_base_set_permissions'); ?>;
myLabel.revert_status = <?php __encode('plugin_base_revert_status'); ?>;
myLabel.exported = <?php __encode('plugin_base_export'); ?>;
myLabel.active = <?php __encode('plugin_base_filter_ARRAY_active'); ?>;
myLabel.inactive = <?php __encode('plugin_base_filter_ARRAY_inactive'); ?>;
myLabel.delete_selected = <?php __encode('plugin_base_delete_selected'); ?>;
myLabel.delete_confirmation = <?php __encode('plugin_base_delete_confirmation'); ?>;
</script>