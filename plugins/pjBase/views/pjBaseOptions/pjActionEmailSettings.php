    			...
    			<div class="ibox-content">
    				...
    				if (isset($tpl['arr']) && is_array($tpl['arr']) && !empty($tpl['arr']))
    				{
                        ...
                        <form action="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjBaseOptions&amp;action=pjActionOptionsUpdate" method="post" class="form-horizontal" id="frmEmailSettings">
                            ...
                            {
                                $rowClass = NULL;
                                if (in_array($option['key'], array('o_smtp_host', 'o_smtp_port', 'o_smtp_user', 'o_smtp_pass', 'o_smtp_auth', 'o_smtp_secure')))
                                {
                                ...
                                <div class="form-group<?php echo $rowClass; ?>">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        {
                                            case 'string':
                                                ?><input type="text" name="value-<?php echo $option['type']; ?>-<?php echo $option['key']; ?>" class="form-control<?php echo $option['key'] == 'o_sender_email'? ' email': null; ?>" value="<?php echo pjSanitize::html($option['value']); ?>"><?php
                                                break;
                                            case 'text':
...
myLabel.test_smtp_title = <?php __encode('plugin_base_test_smtp_title'); ?>;
myLabel.test_smtp_text = <?php __encode('plugin_base_test_smtp_text'); ?>;
myLabel.send_test_email_title = <?php __encode('plugin_base_send_test_email_title'); ?>;
myLabel.send_test_email_text = <?php __encode('plugin_base_send_test_email_text'); ?>;
myLabel.send_test_email_address = <?php __encode('plugin_base_send_test_email_address'); ?>;

myLabel.btn_yes_connect = <?php __encode('plugin_base_btn_yes_connect'); ?>;
myLabel.btn_send_email = <?php __encode('plugin_base_btn_send_email'); ?>;
