...
<nav class="navbar-default navbar-static-side" role="navigation">
    <div class="sidebar-collapse">
        <ul class="nav metismenu" id="side-menu">
            ...
            $hasAccessSystemOptions     = $hasAccessGeneralOptions || $hasAccessApiKeys || $hasAccessEmailSettings || $hasAccessSms || $hasAccessLocale || $hasAccessLoginProtection || $hasAccessCaptchaSpam || $hasAccessVisual || $hasAccessCronJobs || $hasAccessBackup;
            ?>
