    						...
    						<div class="ibox-content no-margins no-padding no-top-border">
                                <?php if ($tpl['has_access_import'] || $tpl['has_access_export']): ?>
                                    <?php if ($tpl['has_access_import']): ?>
                                        <form action="<?php echo PJ_INSTALL_URL; ?>index.php?controller=pjBaseLocale&amp;action=pjActionImportConfirm" method="post" class="form-horizontal" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                                        ...
                                                        <span class="fileinput-exists"><i class="fa fa-upload m-r-xs"></i><?php __('plugin_base_locale_change_file');?></span><input name="file" type="file" required></span>
