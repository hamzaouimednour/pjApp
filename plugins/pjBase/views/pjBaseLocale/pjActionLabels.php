...
var pjGrid = pjGrid || {};
var myLabel = myLabel || {};
myLabel.id = <?php __encode('plugin_base_locale_id'); ?>;
myLabel.default_language = <?php echo pjBaseAppController::jsonEncode($tpl['default_language']); ?>;
myLabel.language = <?php __encode('plugin_base_locale_translate_to'); ?>;
myLabel.field_type = <?php __encode('plugin_base_locale_field_type'); ?>;
