...
var myLabel = myLabel || {};
myLabel.alert_title = <?php __encode('plugin_base_cront_alert_title'); ?>;
myLabel.alert_text = <?php __encode('plugin_base_cront_alert_text'); ?>;
myLabel.btn_confirm = <?php __encode('plugin_base_btn_confirm'); ?>;
