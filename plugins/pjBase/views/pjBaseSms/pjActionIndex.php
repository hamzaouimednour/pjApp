                            ...
                            <div class="row text-center">
                                <div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-7">
                                            <div class="form-group">
                                                <input type="text" id="plugin_sms_api_key" name="plugin_sms_api_key" value="<?php echo !empty($tpl['option_arr']['plugin_sms_api_key']) ? $tpl['option_arr']['plugin_sms_api_key'] : NULL;?>" class="form-control form-control-lg" placeholder="<?php __('plugin_base_sms_api_key', false, true);?>">
                                            </div><!-- /.form-group -->
                                        </div><!-- /.col-lg-8 -->

                                        <div class="col-lg-5">
                                            <a href="#" class="btn btn-primary btn-outline btn-lg btn-block btnVerify"><i class="fa fa-check-circle-o m-r-xs"></i> <?php __('plugin_base_btn_verify_your_key');?></a>
                                        </div><!-- /.col-lg-4 -->
                                    </div><!-- /.form-group -->
...
var pjGrid = pjGrid || {};
var myLabel = myLabel || {};
myLabel.created = <?php __encode('plugin_base_sms_date_time_sent'); ?>;
myLabel.number = <?php __encode('plugin_base_sms_number'); ?>;
myLabel.text = <?php __encode('plugin_base_sms_message'); ?>;
myLabel.status = <?php __encode('plugin_base_sms_status'); ?>;

myLabel.test_sms_title = <?php __encode('plugin_base_sms_test_sms_title'); ?>;
myLabel.test_sms_text = <?php __encode('plugin_base_sms_test_sms_text'); ?>;
myLabel.test_sms_number = <?php __encode('plugin_base_sms_number'); ?>;
myLabel.btn_send_sms = <?php __encode('plugin_base_btn_send_sms'); ?>;
myLabel.btn_cancel = <?php __encode('plugin_base_btn_cancel'); ?>;
</script>