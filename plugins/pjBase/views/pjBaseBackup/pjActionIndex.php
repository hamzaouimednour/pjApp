...
var myLabel = myLabel || {};
myLabel.backup_made = <?php __encode('plugin_base_backup_backup_made'); ?>;
myLabel.data_type = <?php __encode('plugin_base_backup_data_type'); ?>;
myLabel.file_size = <?php __encode('plugin_base_backup_file_size'); ?>;
myLabel.file_name = <?php __encode('plugin_base_backup_file_name'); ?>;
myLabel.delete_confirmation = <?php __encode('plugin_base_backup_delete_confirmation'); ?>;
myLabel.delete_selected = <?php __encode('plugin_base_backup_delete_selected'); ?>;
</script>