            ...
            <?php if($login_2_factor == 'No' || $second_factor == true): ?>
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <input type="password" name="login_password" id="login_password" class="form-control form-control-lg required" placeholder="<?php __('plugin_base_login_password', false, true); ?>" autocomplete="off" data-msg-required="<?php __('plugin_base_this_field_is_required', false, true);?>" value="pass">
                    </div>
