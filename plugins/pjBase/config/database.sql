...
(1, 'o_auto_backup', 9, 'Yes|No::No', 'Yes|No', 'enum', 1, 0, NULL),
...
(1, 'o_secure_login_use_captcha', 5, 'Yes|No::Yes', 'Yes|No', 'enum', 7, 1, NULL),
...
SET @id := (SELECT LAST_INSERT_ID());
INSERT INTO `plugin_base_multi_lang` VALUES (NULL, @id, 'pjBaseField', '::LOCALE::', 'title', 'You do not have an SMS key. More details <a href="index.php?controller=pjBaseSms&action=pjActionIndex">here</a>.', 'plugin');
