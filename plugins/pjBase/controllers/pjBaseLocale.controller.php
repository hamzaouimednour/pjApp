...
class pjBaseLocale extends pjBase
{
	...
	public function pjActionLabels()
	{
	    ...
	    if (self::isPost())
	    {
	        ...
	        {
	        	if (pjAuth::factory()->hasAccess('showIds'))
                {
	    ...
	    if (self::isGet())
	    {
	        $this->set('has_access_show_ids', pjAuth::factory()->hasAccess('showIds'));
	...
	public function pjActionImportExport()
	{
        ...
        $this->set('has_access_import', $pjAuth->hasAccess('import'));
        $this->set('has_access_export', $pjAuth->hasAccess('export'));
	...
	public function pjActionExport()
	{
	    ...
	    if (!pjAuth::factory('pjBaseLocale', 'pjActionImportExport')->hasAccess('export'))
	    {
	        $this->sendForbidden();
	        return;
	    }
